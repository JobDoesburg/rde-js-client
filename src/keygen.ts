...
import RDEDocumentUtils from "./keygen/RDEDocumentUtils";
...
export { RDEDecryptionParameters, RDEDocumentUtils, RDEEnrollmentParameters, RDEKey, RDEKeyGenerator, utils };